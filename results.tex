...
is evaluated in \alphazero-scheme again. \revised{This choice is motivated by the fact
...
covers all higher order effect. Therefore it is interesting and important to investigate
...
\begin{figure}[t!]
  ...
  \caption{
    ...
    using out central scale choice.}
    \label{fig:aaa:pt}
  }
\end{figure}
