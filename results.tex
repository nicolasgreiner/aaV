...
We put no requirements on the missing transverse momentum. 
The inclusive cross sections and correction factors were 
detailed in Tab.\ \ref{tab:xsec}.
\comment{MS: Nico, please check!}
...
lepton. 
As was observed in tiple photon production, the inclusive 
...
and $-20\%$ for the subleading photon at 500\,GeV. 
...
Figure \ref{fig:aaa:myy} also displays the transverse 
...
again loosening the transverse momentum requirements to 
$\pT>20\,\text{GeV}$ for both the leading and the subleading 
identified photon. 
We further demand the angular separation of both photons 
to be $\Delta R(\gamma_1,\gamma_2)>0.4$ and each photon and 
...
at 500\,GeV. 
The electroweak corrections negative throughout, increasing 
from $\deltaEW=-5\%$ at low transverse momenta to $-20\%$ at 
500\,GeV.
...
$\tfrac{1}{2}\,\pi$. 
\comment{MS: Do we understand why this is?}
