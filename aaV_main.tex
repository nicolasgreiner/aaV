...
\preprint{
  \small
  \begin{flushright}
    ZU--TH--??\\ CERN-TH-2017-226
  \end{flushright}
}

\abstract{
Processes with three external electroweak gauge boson allow for a measurement of triple and quartic gauge
couplings. They allow for a constraint of anomalous gauge couplings, where new physics might predominantly
...
order QCD and electroweak corrections to these processes with a particular emphasize on the until now unknown 
...
per cent at most, but can reach several tens of per cent in regions of phase space  that are particularly interesting
 ...
 when combining
QCD and electroweak corrections and we asess the importance of photon induced contributions to these processes. 
}
