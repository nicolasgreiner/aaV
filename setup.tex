...
NLO QCD corrections to $ZZ+j$, $h+0,1,2,3\,\text{jets}$ production 
\cite{Binoth:2009wk,Hoeche:2013mua,Greiner:2015jha,Greiner:2016awe} and the 
NLO EW corrections to $\gamma\gamma+0,1,2\,\text{jets}$ production 
in \cite{Chiesa:2017gqx}.

\comment{Shall we cite more or less here?}